...
//        tabOne.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_tab_movies, 0, 0);
        tabLayout.getTabAt(0).setCustomView(tabOne);


        TextView tabTwo = (TextView) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
        tabTwo.setText("TV");
//        tabTwo.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_tab_tv, 0, 0);
        tabLayout.getTabAt(1).setCustomView(tabTwo);

        TextView tabThree = (TextView) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
        tabThree.setText("CELEBS");
//        tabThree.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_tab_celebs, 0, 0);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new OneFragment(), "TV");
        adapter.addFrag(new TwoFragment(), "Celebs");
